...
* `get_energy`:
  ...
  ```
  This contains charge equilbrant process, and retruns total energy after charge equlibrant.
  ...
  Input:
      ...
      J:
          Na: the atomic hardness
      aux:
          bool: whether to intruduce auxilliary parameters, equilibrated atomic charges and lagmt
  Output:
      energy: total energy after charge equlibrant
  ```
