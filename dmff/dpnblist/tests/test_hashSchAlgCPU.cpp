...
#include "../src/SchAlg/hashSchAlgCPU.h"
...
namespace dpnblist {
    ...
    void nblist_test_HashCPU(std::string filename, std::string reffilename, float r_cutoff, float skin = 0.0){
        ...
        HashSearchCPU s_alg(box, xyz, r_cutoff);
        s_alg.search();
    ...
    TEST_SUITE("Test Ref Hash List")
    {
        ...
        TEST_CASE("Hash List on CPU"){
        // test1
            nblist_test_HashCPU("heterogeneous.lmp", "sort_output_heterogeneous.txt", 3.0, 0.0);
