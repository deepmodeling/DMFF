...
#include "../src/SchAlg/hashSchAlgGPU.cuh"
...
namespace dpnblist {
    ...
    void nblist_test_HashGPU(std::string filename, std::string reffilename, float r_cutoff, float skin = 0.0){
        ...
        HashSearchGPU s_alg(box, xyz, r_cutoff);
        s_alg.search();
    ...
    TEST_SUITE("Test Ref Hash List")
    {

        
        TEST_CASE("Hash List on GPU"){
        // test1
            nblist_test_HashGPU("heterogeneous.lmp", "sort_output_heterogeneous.txt", 3.0, 0.0);
